/* =========================================================
   ...
   1) DUK — atsakymas išsiskleidžia toje pačioje dėžutėje
   2) dengiamumo žemėlapio išskleidimas
   (Technologijų kortelės daugiau nebeatidaro modalo — "Details"
   nuoroda kiekvienoje kortelėje veda tiesiai į silo-technology.html)
   ========================================================= */
(function () {
  'use strict';
